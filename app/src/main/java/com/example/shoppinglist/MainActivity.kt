    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                ProfileItem(label = "Nama", value = "Farhan Arva Amanta", bold = true)
                Divider(thickness = 0.5.dp)
                ProfileItem(label = "NIM", value = "2311523038")
                Divider(thickness = 0.5.dp)
                ProfileItem(label = "TTL", value = "Padang, 08 Juli 2004")
                Divider(thickness = 0.5.dp)
                ProfileItem(label = "Hobi", value = "Melukis")
                Divider(thickness = 0.5.dp)
                ProfileItem(label = "Peminatan", value = "Web Programming")
            }
        }
    }
}
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text("Dibuat oleh : Farhan Arva Amanta")
